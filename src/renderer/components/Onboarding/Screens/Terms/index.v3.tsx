...
const TermsContainer: ThemedComponent<unknown> = styled.div`
  height: 100%;
  width: 100%;
  display: flex;
...
const TermsBody: ThemedComponent<unknown> = styled(Box)`
  margin-bottom: 1.5em;
  row-gap: 2rem;
`;

const TermsLinks: ThemedComponent<unknown> = styled(Box)`
  row-gap: 1rem;
`;
