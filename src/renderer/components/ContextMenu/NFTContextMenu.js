...
import { NFT } from "@ledgerhq/live-common/lib/types";
...
export default function NFTContextMenu({ leftClick, children, contract, tokenId, nft }: Props) {
  const { t } = useTranslation();
  const { metadata } = useNftResource(nft);
