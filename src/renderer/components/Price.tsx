...
import { Currency, Unit } from "@ledgerhq/live-common/lib/types/currencies";
...
type RenderRawProps = {
  activityColor: JSX.Element;
  icon: JSX.Element;
  actualValueFormatted: JSX.Element;
  counterValueFormatted: JSX.Element;
};
