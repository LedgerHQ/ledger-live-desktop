...
type Props = {
  ...
  firmware: FirmwareUpdateContext | null | undefined;
  stepId: StepId;
  error: MaybeError;
  deviceModelId: DeviceModelId;
  deviceInfo: DeviceInfo;
...
const HookMountUnmount = ({ onMountUnmount }: { onMountUnmount: (arg0: boolean) => void }) => {
  useEffect(() => {
    onMountUnmount(true);
