...
const PasswordShowPassword = (props: Props) => {
  ...
  const onClose = () => {
    dispatch(closeModal("MODAL_PASSWORD_SHOW_PASSWORD"));
  };
  ...
  return (
    <>
      ...
      <Modal name="MODAL_PASSWORD_SHOW_PASSWORD" centered>
        <ModalBody
          title="Show Password"
          onHide={() => {}}
          onClose={onClose}
...
export default PasswordShowPassword;
