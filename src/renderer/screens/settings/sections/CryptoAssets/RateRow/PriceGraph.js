...
class PriceGraph extends Component<Props> {
  render() {
...
const PriceGraphOut: React$ComponentType<OwnProps> = connect(mapStateToProps)(PriceGraph);

export default PriceGraphOut;
